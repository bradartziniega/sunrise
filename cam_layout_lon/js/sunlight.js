...
function init()
{
	...
	mapImage = new Image(); 
	mapImage.src = '../html5-canvas-demo/map.svg';
	...
	for (var x = 0; x < mapWidth; ++x)
		...
		{			
			...
			{                                              
				...
				//outputs lat & lng...should be able to plot onto gmaps?
				var lat=(rectHeight/(mapHeight/180)-90)/-1;
				var lng = x/(mapWidth/360)-180;
